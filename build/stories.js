...
function DonutComponent(total, diff, categories) {
  ...
  var offsetValues = [0, dashArrayValues[0][1], dashArrayValues[0][1] + dashArrayValues[1][1], dashArrayValues[0][1] + dashArrayValues[1][1] + dashArrayValues[2][1]]; // console.log(values, dashArrayValues, offsetValues)
